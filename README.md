...
* 2” Color Display for monitoring network and displaying status registers of MAC
* 3 buttons for stand alone operations such as 10BASE-T1S test modes and network setup
